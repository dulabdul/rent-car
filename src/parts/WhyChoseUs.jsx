...
export default function WhyChoseUs() {
  ...
  return (
    <section className='w-full pt-4 pb-12 bg-gradient-to-t from-[#FAFAFA] to-[#FAFAFA]  overflow-hidden flex items-center justify-center'>
      <div className='container mx-auto w-full items-center justify-center overflow-hidden grid grid-cols-1 md:grid-cols-2'>
        ...
        <div className='w-full h-full flex flex-col justify-center'>
          ...
          <h2 className='font-semibold text-start text-primary capitalize text-4xl mb-4'>
          ...
          {arrFeatured.map((items, index) => {
            return (
              <div
                key={index}
                className='w-full flex items-center p-2 justify-start overflow-hidden'>
                <div className='flex items-center justify-center bg-white w-[44px] h-[44px] shadow-md rounded-xl'>
                  <img
                    src={items.src}
                    alt={items.alt}
                  />
                ...
                <div className='ml-6'>
                  <h5 className='capitalize text-primary font-normal text-lg'>
                    {items.title}
                  </h5>
                  <p className='text-tersier text-base font-normal capitalize'>
                    {items.description}
                  </p>
                </div>
              </div>
